...
#define PERSIST_IS_ALL_DAY				0xEC5A
#define PERSIST_DAY						0xEC5B
#define PERSIST_MONTH					0xEC5C
#define PERSIST_HOUR					0xEC5D
#define PERSIST_MINUTE					0xEC5E
#define PERSIST_EVENT_STRG				0xEC5F
...
/*
typedef enum {CALENDAR_APP, MUSIC_APP, GPS_APP, STOCKS_APP, BITCOIN_APP, CAMERA_APP, WEATHER_APP, URL_APP, FINDPHONE_APP, REMINDERS_APP, CANVAS_APP, STATUS_SCREEN_APP} AppIDs;

static char *app_names[] = {"Calendar", "Music", "GPS", "Stocks", "Bitcoin", "Camera", "Weather", "HTTP Request", "Find My Phone", "Reminders", "Canvas"};
*/
...
//void display_gps();
//void display_calendar(int app_id);
// //void display_music();
//void display_camera();
//void display_stocks(int app_id);
//void display_weather();
//void display_url();
//void display_activator();
//void display_canvas();
//void display_call_text(int app_id);
//void display_tertiary();
//void setURLBack();

void set_sms_status(int s);

void display_settings(Window **window);

//void set_container_image(Window window, BmpContainer *bmp_container, const int resource_id, GPoint origin);

//char* int_to_str(long long num, char *outbuf);


//extern void *g_app_context;

void hideInverterLayers();
//void hideInverterURLLayers();
